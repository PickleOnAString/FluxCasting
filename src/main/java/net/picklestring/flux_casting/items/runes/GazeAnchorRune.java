...
public class GazeAnchorRune extends RuneItem {
	public GazeAnchorRune(Settings settings) {
		super(settings,
			new Type[][]{ new Type[]{LivingEntity.class} },
			Vector3.class,
			new Identifier(FluxCasting.ModID, "textures/gui/rune_overlay/gaze_anchor_rune_overlay.png"));
	}
	...
	public Object getValue(DefaultedList<ItemStack> inventory, int runeIndex, PlayerEntity caster, Vec3d pos, World world) {
		...
		return Vector3.Vec3dToVector3(entity.getEyePos());
	}
}
