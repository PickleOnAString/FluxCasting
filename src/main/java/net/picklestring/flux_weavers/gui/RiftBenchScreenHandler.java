...
import net.picklestring.flux_weavers.ImplementedInventory;
import net.picklestring.flux_weavers.blocks.entity.RiftBenchEntity;
import net.picklestring.flux_weavers.registries.ScreenRegistry;
...
public class RiftBenchScreenHandler extends ScreenHandler {
	...
	protected static void craft(ScreenHandler handler, World world, PlayerEntity player, ImplementedInventory inventory, BlockPos pos) {
		...
		FluxWeavers.LOGGER.info("TESTING CRAFTING");
