...
public class RuneTableScreen extends HandledScreen<RuneTableScreenHandler> {
	private static final Identifier TEXTURE = Identifier.of(FluxWeavers.ModID, "textures/gui/rune_table_screen.png");
	private static final Identifier TEXTURE_FLUX_INPUT = Identifier.of(FluxWeavers.ModID, "textures/gui/rune_table_screen_flux_input.png");

	private static final Identifier RUNE_OVERLAY = Identifier.of(FluxWeavers.ModID, "textures/gui/rune_overlay/debug_rune_overlay.png");
