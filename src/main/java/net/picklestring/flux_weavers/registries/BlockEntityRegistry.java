...
import net.picklestring.flux_weavers.blocks.entity.FluxStoneLeakEntity;
import net.minecraft.registry.Registries;
import net.minecraft.registry.Registry;
import net.picklestring.flux_weavers.blocks.entity.RiftBenchEntity;
...
public class BlockEntityRegistry {
	...
	{
		Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(FluxWeavers.ModID, "flux_stone_leak_entity"), FLUX_STONE_LEAK_ENTITY);
		Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(FluxWeavers.ModID, "rift_bench_entity"), RIFT_BENCH_ENTITY);
		Registry.register(Registries.BLOCK_ENTITY_TYPE, Identifier.of(FluxWeavers.ModID, "rune_table_entity"), RUNE_TABLE_ENTITY);
	}
}
